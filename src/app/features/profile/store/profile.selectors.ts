...
export const getRandomUser = createSelector(getUsers, (users) => users[generateRandomNumber(0, users.length - 1)]);
export const getSelectedUuid = createSelector(getProfileState, ({ selectedUuid }) => selectedUuid);
export const getSelectedUser = createSelector(getUsers, getSelectedUuid, (users, uuid) =>
